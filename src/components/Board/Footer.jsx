...
export const Footer = () => {
  ...
  return (
    <div className="h-full w-screen relative before:absolute before:left-0 before:top-9 before:w-full before:bg-dark-purple before:h-full before:rounded-[80px]">
      <div className="h-48 w-full bg-no-repeat bg-center relative z-50 top-3 flex flex-col justify-center items-center pt-6" style={{ backgroundImage: `url(${getBackground()})` }}>
